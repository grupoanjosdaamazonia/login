...
(function () {
  ...
  const EXEMPLOS = [
    { foto_url: 'carro1.png?v=10', empresa_nome: 'AquaMax', formato: 'GD Full', veiculo: 'Chevrolet Onix · Uber Comfort' },
    { foto_url: 'carro2.webp?v=10', empresa_nome: 'Verde Hortifruti', formato: 'GD Door', veiculo: 'BYD Seagull · Uber Black' },
    { foto_url: 'carro3.png?v=10', empresa_nome: 'Sol Turismo', formato: 'GD Light', veiculo: 'Fiat Mobi · 99 Pop' },
  ];
